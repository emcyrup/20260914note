...
urlpatterns = [
    ...
    path('paper/', views.PaperScanListView.as_view(), name='paper_list'),
    path('paper/upload/', views.PaperScanUploadView.as_view(), name='paper_upload'),
    path('paper/<int:pk>/', views.PaperScanReviewView.as_view(), name='paper_review'),
    path('paper/<int:pk>/extract/', views.PaperScanExtractView.as_view(), name='paper_extract'),
    path('paper/<int:pk>/delete/', views.PaperScanDeleteView.as_view(), name='paper_delete'),
